...
export default function AdminPage() {
  ...
  const handleDataUpdate = (data: PortfolioData) => {
    setPortfolioData(data);
  };
    ...
    return (
      <div className="min-h-screen bg-gemini-dark flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gemini-text-secondary">Loading admin panel...</p>
        </div>
      </div>
    );
  }
  ...
  return <AdminPanel portfolioData={portfolioData} onDataUpdate={handleDataUpdate} />;
}
